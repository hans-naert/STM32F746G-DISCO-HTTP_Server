...
/* Last-Modified: Fri, 04 Apr 2025 15:55:57 GMT */
const uint32_t imageLastModified = 1743782157U;

static const uint8_t imageFileData[23798U] = {

  /*-- File: index.htm, 118 bytes --*/
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0x1D1F9D3EU, &imageFileData[118U]   },    // "pg_header.inc"
  { 0x85C7B8E6U, &imageFileData[1166U]  },    // "pg_footer.inc"
  { 0xF8334615U, &imageFileData[1592U]  },    // "ad.cgi"
  { 0xB0E380D2U, &imageFileData[3870U]  },    // "ad.cgx"
  { 0xF46138EAU, &imageFileData[3939U]  },    // "buttons.cgi"
  { 0xBCB1FE2DU, &imageFileData[5632U]  },    // "buttons.cgx"
  { 0xD7FABA9AU, &imageFileData[5672U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[6576U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[7512U]  },    // "leds.cgi"
  { 0xCEC97D75U, &imageFileData[9496U]  },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[11644U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[12895U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[13539U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[16355U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[17744U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[18882U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[20669U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[23677U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[23798U] }
};
